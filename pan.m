...
#define pthread_equal(a,b)	((a)==(b))
	...
	case 2: /* generic 'else' */
		...
		_m = 3; goto P999;
		 ...
		 /* PROC :init: */
	case 3: // STATE 1 - problem1-retry.pml:195 - [(run Shuttle(4,2,1,0))] (0:0:0 - 1)
		IfNotBlocked
		reached[3][1] = 1;
		if (!(addproc(II, 1, 1, 4, 2, 1, 0, 0, 0)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 4: // STATE 2 - problem1-retry.pml:196 - [(run Shuttle(2,4,1,1))] (0:0:0 - 1)
		IfNotBlocked
		reached[3][2] = 1;
		if (!(addproc(II, 1, 1, 2, 4, 1, 1, 0, 0)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 5: // STATE 3 - problem1-retry.pml:197 - [(run Shuttle(5,1,2,2))] (0:0:0 - 1)
		IfNotBlocked
		reached[3][3] = 1;
		if (!(addproc(II, 1, 1, 5, 1, 2, 2, 0, 0)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 6: // STATE 4 - problem1-retry.pml:198 - [(run Shuttle(3,3,3,3))] (0:0:0 - 1)
		IfNotBlocked
		reached[3][4] = 1;
		if (!(addproc(II, 1, 1, 3, 3, 3, 3, 0, 0)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 7: // STATE 5 - problem1-retry.pml:199 - [] (0:13:6 - 1)
		IfNotBlocked
		reached[3][5] = 1;
		;
		...
		;
		_m = 3; goto P999; /* 7 */
	case 8: // STATE 13 - problem1-retry.pml:201 - [(run ShuttleManagementSystem(first.start,first.end,first.size,second.start,second.end,second.size))] (0:0:0 - 1)
		IfNotBlocked
		reached[3][13] = 1;
		if (!(addproc(II, 1, 0, ((P3 *)_this)->_13_3_first.start, ((P3 *)_this)->_13_3_first.end, ((P3 *)_this)->_13_3_first.size, ((P3 *)_this)->_13_3_second.start, ((P3 *)_this)->_13_3_second.end, ((P3 *)_this)->_13_3_second.size)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 9: // STATE 14 - problem1-retry.pml:202 - [(run RailwayNetwork())] (0:0:0 - 1)
		IfNotBlocked
		reached[3][14] = 1;
		if (!(addproc(II, 1, 2, 0, 0, 0, 0, 0, 0)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 10: // STATE 16 - problem1-retry.pml:204 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[3][16] = 1;
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC RailwayNetwork */
	case 11: // STATE 1 - problem1-retry.pml:175 - [shuttleToRailway?request.track,request.direction,request.id] (0:0:3 - 1)
		reached[2][1] = 1;
		...
		;
		_m = 4; goto P999; /* 0 */
	case 12: // STATE 2 - problem1-retry.pml:177 - [] (0:0:0 - 1)
		IfNotBlocked
		reached[2][2] = 1;
		;
		_m = 3; goto P999; /* 0 */
	case 13: // STATE 3 - problem1-retry.pml:178 - [request.direction = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[2][3] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 14: // STATE 4 - problem1-retry.pml:180 - [(!(tracks.trackL2R[request.track]))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][4] = 1;
		if (!( !(((int)now.tracks.trackL2R[ Index(((P2 *)_this)->request.track, 4) ]))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 15: // STATE 5 - problem1-retry.pml:180 - [tracks.trackL2R[request.track] = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[2][5] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 16: // STATE 6 - problem1-retry.pml:180 - [reply.allowed = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[2][6] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 17: // STATE 8 - problem1-retry.pml:181 - [reply.allowed = 0] (0:0:1 - 1)
		IfNotBlocked
		reached[2][8] = 1;
		(trpt+1)->bup.oval = ((int)((P2 *)_this)->reply.allowed);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 18: // STATE 12 - problem1-retry.pml:185 - [(!(tracks.trackR2L[request.track]))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][12] = 1;
		if (!( !(((int)now.tracks.trackR2L[ Index(((P2 *)_this)->request.track, 4) ]))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 19: // STATE 13 - problem1-retry.pml:185 - [tracks.trackL2R[request.track] = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[2][13] = 1;
		(trpt+1)->bup.oval = ((int)now.tracks.trackL2R[ Index(((P2 *)_this)->request.track, 4) ]);
		now.tracks.trackL2R[ Index(((P2 *)_this)->request.track, 4) ] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 20: // STATE 14 - problem1-retry.pml:185 - [reply.allowed = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[2][14] = 1;
		(trpt+1)->bup.oval = ((int)((P2 *)_this)->reply.allowed);
		((P2 *)_this)->reply.allowed = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 21: // STATE 16 - problem1-retry.pml:186 - [reply.allowed = 0] (0:0:1 - 1)
		IfNotBlocked
		reached[2][16] = 1;
		(trpt+1)->bup.oval = ((int)((P2 *)_this)->reply.allowed);
		((P2 *)_this)->reply.allowed = 0;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 22: // STATE 21 - problem1-retry.pml:189 - [railwayToShuttle[request.id]!reply.allowed] (0:0:0 - 7)
		IfNotBlocked
		reached[2][21] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 23: // STATE 25 - problem1-retry.pml:191 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[2][25] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC Shuttle */
	case 24: // STATE 1 - problem1-retry.pml:82 - [managementToShuttle[id]?order.start,order.end,order.size] (0:0:3 - 1)
		reached[1][1] = 1;
		...
		;
		_m = 4; goto P999; /* 0 */
	case 25: // STATE 2 - problem1-retry.pml:84 - [currentPosition = 0] (0:0:1 - 1)
		IfNotBlocked
		reached[1][2] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 26: // STATE 3 - problem1-retry.pml:85 - [(travelling)] (14:0:2 - 1)
		IfNotBlocked
		reached[1][3] = 1;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 27: // STATE 6 - problem1-retry.pml:86 - [currentPosition = currentStation] (0:14:2 - 1)
		IfNotBlocked
		reached[1][6] = 1;
		(trpt+1)->bup.ovals = grab_ints(2);
		(trpt+1)->bup.ovals[0] = ((P1 *)_this)->currentPosition;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 28: // STATE 9 - problem1-retry.pml:89 - [distance = 0] (0:14:1 - 3)
		IfNotBlocked
		reached[1][9] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 29: // STATE 10 - problem1-retry.pml:90 - [((currentPosition>order.start))] (20:0:1 - 1)
		IfNotBlocked
		reached[1][10] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 30: // STATE 13 - problem1-retry.pml:91 - [distance = (order.start-currentPosition)] (0:0:1 - 1)
		IfNotBlocked
		reached[1][13] = 1;
		(trpt+1)->bup.oval = ((P1 *)_this)->distance;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 31: // STATE 16 - problem1-retry.pml:94 - [((distance>(4/2)))] (31:0:1 - 1)
		IfNotBlocked
		reached[1][16] = 1;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 32: // STATE 19 - problem1-retry.pml:95 - [distance = distance] (0:31:1 - 1)
		IfNotBlocked
		reached[1][19] = 1;
		(trpt+1)->bup.oval = ((P1 *)_this)->distance;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 33: // STATE 22 - problem1-retry.pml:98 - [] (0:31:0 - 3)
		IfNotBlocked
		reached[1][22] = 1;
		;
		_m = 3; goto P999; /* 0 */
	case 34: // STATE 23 - problem1-retry.pml:99 - [((((currentLoad+order.size)<=capacity)&&(distance<=2)))] (33:0:4 - 1)
		IfNotBlocked
		reached[1][23] = 1;
		...
		;
		_m = 3; goto P999; /* 4 */
	case 35: // STATE 28 - problem1-retry.pml:102 - [offer.id = id] (0:33:3 - 1)
		IfNotBlocked
		reached[1][28] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 3 */
	case 36: // STATE 33 - problem1-retry.pml:104 - [shuttleToManagement!offer.id,offer.charge,offer.refuse] (0:0:0 - 3)
		IfNotBlocked
		reached[1][33] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 37: // STATE 34 - problem1-retry.pml:105 - [managementToShuttle[id]?order.start,order.end,order.size] (0:0:3 - 1)
		reached[1][34] = 1;
		if (q_len(now.managementToShuttle[ Index(((P1 *)_this)->id, 4) ]) == 0) continue;
		...
		;
		_m = 4; goto P999; /* 0 */
	case 38: // STATE 35 - problem1-retry.pml:107 - [((order.size>=0))] (0:0:0 - 1)
		IfNotBlocked
		reached[1][35] = 1;
		if (!((((P1 *)_this)->order.size>=0)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 39: // STATE 36 - problem1-retry.pml:107 - [orders!order.start,order.end,order.size] (0:0:0 - 1)
		IfNotBlocked
		reached[1][36] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 40: // STATE 41 - problem1-retry.pml:110 - [((nempty(orders)&&!(processingOrder)))] (0:0:1 - 1)
		IfNotBlocked
		reached[1][41] = 1;
		...
		_m = 3; goto P999; /* 0 */
	case 41: // STATE 42 - problem1-retry.pml:111 - [orders?order.start,order.end,order.size] (0:0:3 - 1)
		reached[1][42] = 1;
		...
		(trpt+1)->bup.ovals[2] = ((P1 *)_this)->order.size;
		;
		((P1 *)_this)->order.start = qrecv(((P1 *)_this)->orders, XX-1, 0, 0);
#ifdef VAR_RANGES
		logval("Shuttle:order.start", ((P1 *)_this)->order.start);
#endif
		;
		((P1 *)_this)->order.end = qrecv(((P1 *)_this)->orders, XX-1, 1, 0);
#ifdef VAR_RANGES
		logval("Shuttle:order.end", ((P1 *)_this)->order.end);
#endif
		;
		((P1 *)_this)->order.size = qrecv(((P1 *)_this)->orders, XX-1, 2, 1);
#ifdef VAR_RANGES
		logval("Shuttle:order.size", ((P1 *)_this)->order.size);
#endif
		;
		...
		;
		_m = 4; goto P999; /* 0 */
	case 42: // STATE 43 - problem1-retry.pml:112 - [printf('[Shuttle %d] Starting new order from station %d to station %d\\n',id,order.start,order.end)] (0:51:4 - 1)
		IfNotBlocked
		reached[1][43] = 1;
		Printf("[Shuttle %d] Starting new order from station %d to station %d\n", ((P1 *)_this)->id, ((P1 *)_this)->order.start, ((P1 *)_this)->order.end);
...
#endif
		;
		/* merge: destination = order.start(51, 45, 51) */
		reached[1][45] = 1;
		(trpt+1)->bup.ovals[1] = ((P1 *)_this)->destination;
		((P1 *)_this)->destination = ((P1 *)_this)->order.start;
#ifdef VAR_RANGES
		...
		;
		_m = 3; goto P999; /* 3 */
	case 43: // STATE 47 - problem1-retry.pml:117 - [(((order.start>=currentStation)&&((order.start-currentStation)<(4/2))))] (53:0:1 - 1)
		IfNotBlocked
		reached[1][47] = 1;
		if (!(((((P1 *)_this)->order.start>=((P1 *)_this)->currentStation)&&((((P1 *)_this)->order.start-((P1 *)_this)->currentStation)<(4/2)))))
			continue;
		/* merge: direction = 1(0, 48, 53) */
		reached[1][48] = 1;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 44: // STATE 50 - problem1-retry.pml:119 - [direction = -(1)] (0:0:1 - 1)
		IfNotBlocked
		reached[1][50] = 1;
		(trpt+1)->bup.oval = ((P1 *)_this)->direction;
		((P1 *)_this)->direction =  -(1);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 45: // STATE 56 - problem1-retry.pml:168 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[1][56] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
	...
	case 46: // STATE 1 - problem1-retry.pml:42 - [orders[0].start = first.start] (0:60:8 - 1)
		IfNotBlocked
		reached[0][1] = 1;
		...
		;
		_m = 3; goto P999; /* 8 */
	case 47: // STATE 9 - problem1-retry.pml:45 - [((i<=(2-1)))] (17:0:2 - 1)
		IfNotBlocked
		reached[0][9] = 1;
		if (!((((P0 *)_this)->i<=(2-1))))
			continue;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 48: // STATE 12 - problem1-retry.pml:47 - [((j<=(4-1)))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][12] = 1;
		if (!((((P0 *)_this)->_10_1_j<=(4-1))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 49: // STATE 13 - problem1-retry.pml:48 - [managementToShuttle[j]!orders[i].start,orders[i].end,orders[i].size] (0:0:0 - 1)
		IfNotBlocked
		reached[0][13] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 50: // STATE 14 - problem1-retry.pml:47 - [j = (j+1)] (0:0:1 - 1)
		IfNotBlocked
		reached[0][14] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 51: // STATE 20 - problem1-retry.pml:51 - [minCharge = 2147483647] (0:37:3 - 3)
		IfNotBlocked
		reached[0][20] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 3 */
	case 52: // STATE 23 - problem1-retry.pml:54 - [((j<=(4-1)))] (25:0:0 - 1)
		IfNotBlocked
		reached[0][23] = 1;
		if (!((((P0 *)_this)->_10_1_j<=(4-1))))
			continue;
		...
		;
		_m = 3; goto P999; /* 1 */
	case 53: // STATE 25 - problem1-retry.pml:56 - [shuttleToManagement?offer.id,offer.charge,offer.refuse] (0:0:3 - 1)
		reached[0][25] = 1;
		...
		;
		_m = 4; goto P999; /* 0 */
	case 54: // STATE 26 - problem1-retry.pml:58 - [(((offer.charge<minCharge)&&!(offer.refuse)))] (37:0:4 - 1)
		IfNotBlocked
		reached[0][26] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 55: // STATE 30 - problem1-retry.pml:59 - [minCharge = minCharge] (0:37:3 - 1)
		IfNotBlocked
		reached[0][30] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		(trpt+1)->bup.ovals[0] = ((P0 *)_this)->_10_1_minCharge;
		...
		;
		_m = 3; goto P999; /* 4 */
	case 56: // STATE 34 - problem1-retry.pml:54 - [j = (j+1)] (0:37:1 - 3)
		IfNotBlocked
		reached[0][34] = 1;
		(trpt+1)->bup.oval = ((P0 *)_this)->_10_1_j;
		((P0 *)_this)->_10_1_j = (((P0 *)_this)->_10_1_j+1);
		...
		;
		_m = 3; goto P999; /* 1 */
	case 57: // STATE 40 - problem1-retry.pml:62 - [printf('[Management System]: New Order assigned to Shuttle %d\\n',assignedId)] (0:54:1 - 3)
		IfNotBlocked
		reached[0][40] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 58: // STATE 42 - problem1-retry.pml:63 - [((j<=(4-1)))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][42] = 1;
		if (!((((P0 *)_this)->_10_1_j<=(4-1))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 59: // STATE 43 - problem1-retry.pml:65 - [((j==assignedId))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][43] = 1;
		if (!((((P0 *)_this)->_10_1_j==((P0 *)_this)->_10_1_assignedId)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 60: // STATE 44 - problem1-retry.pml:65 - [managementToShuttle[j]!orders[i].start,orders[i].end,orders[i].size] (0:0:0 - 1)
		IfNotBlocked
		reached[0][44] = 1;
		if (q_full(now.managementToShuttle[ Index(((P0 *)_this)->_10_1_j, 4) ]))
			continue;
		...
		qsend(now.managementToShuttle[ Index(((P0 *)_this)->_10_1_j, 4) ], 0, ((P0 *)_this)->orders[ Index(((P0 *)_this)->i, 2) ].start, ((P0 *)_this)->orders[ Index(((P0 *)_this)->i, 2) ].end, ((P0 *)_this)->orders[ Index(((P0 *)_this)->i, 2) ].size, 3);
		_m = 2; goto P999; /* 0 */
	case 61: // STATE 46 - problem1-retry.pml:66 - [] (0:48:1 - 1)
		IfNotBlocked
		reached[0][46] = 1;
		;
		...
		;
		_m = 3; goto P999; /* 1 */
	case 62: // STATE 48 - problem1-retry.pml:66 - [managementToShuttle[j]!dummy.start,dummy.end,dummy.size] (0:0:0 - 1)
		IfNotBlocked
		reached[0][48] = 1;
		if (q_full(now.managementToShuttle[ Index(((P0 *)_this)->_10_1_j, 4) ]))
			continue;
		...
		_m = 2; goto P999; /* 0 */
	case 63: // STATE 51 - problem1-retry.pml:63 - [j = (j+1)] (0:54:1 - 3)
		IfNotBlocked
		reached[0][51] = 1;
		(trpt+1)->bup.oval = ((P0 *)_this)->_10_1_j;
		((P0 *)_this)->_10_1_j = (((P0 *)_this)->_10_1_j+1);
		...
		;
		_m = 3; goto P999; /* 1 */
	case 64: // STATE 57 - problem1-retry.pml:45 - [i = (i+1)] (0:60:1 - 3)
		IfNotBlocked
		reached[0][57] = 1;
		...
		;
		_m = 3; goto P999; /* 1 */
	case 65: // STATE 63 - problem1-retry.pml:70 - [-end-] (0:0:0 - 3)
		IfNotBlocked
		reached[0][63] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
